...
#define SELECTED_ATTR   (COLOR(DEFAULT) | A_NORMAL)
...
#define TAG_SEL      (COLOR(BLUE) | A_NORMAL)
/* curses attributes for not selected tags which contain no windows */
#define TAG_NORMAL   (COLOR(DEFAULT) | A_DIM)
/* curses attributes for not selected tags which contain windows */
#define TAG_OCCUPIED (COLOR(BLUE) | A_DIM )
/* curses attributes for not selected tags which with urgent windows */
#define TAG_URGENT   URGENT_ATTR
...
static KeyBinding bindings[] = {
	...
	{ { MOD, 'g', 'm',     }, { setlayout,      { TILE_SYMBOL }             } },
	{ { MOD, 'g', 'g',     }, { setlayout,      { GRID_SYMBOL }             } },
	{ { MOD, 'g', 'b',     }, { setlayout,      { BSTACK_SYMBOL }           } },
	{ { MOD, 'g', 't',     }, { setlayout,      { TSTACK_SYMBOL }           } },
	{ { MOD, 'g', 'v',     }, { setlayout,      { VSTACK_SYMBOL }           } },
	{ { MOD, 'g', 'f',     }, { setlayout,      { FULLSCREEN_SYMBOL }       } },
	{ { MOD, ' ',          }, { setlayout,      { NULL }                    } },
	{ { MOD, 'i',          }, { incnmaster,     { "+1" }                    } },
	{ { MOD, 'd',          }, { incnmaster,     { "-1" }                    } },
	{ { MOD, '<',          }, { setmfact,       { "-0.05" }                 } },
